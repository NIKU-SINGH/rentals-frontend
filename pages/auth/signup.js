        ...
        <div className='mt-10 mb-10 ml-48 mr-48 bg-red-500 flex items-center justify-center'>
            <section className="bg-white">
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <section
                        className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6 rounded-3xl"
                    >
                        <img
                            alt="Night"
                            src="https://images.unsplash.com/photo-1607000975574-0b425df6975a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80"
                            ...
                            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                                <div className="col-span-6">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 w-full p-2 border-none rounded-md border-gray-200 bg-gray-100 text-sm text-gray-700 shadow-sm"
                                    />
                                </div>
                                ...
                                <div className="col-span-6">
                                    ...
                                    <input
                                        ...
                                        className="mt-1 w-full p-2 rounded-md border-gray-200 bg-gray-100  text-sm text-gray-700 shadow-sm"
                                    />
                                </div>
