...
function Filter() {
    return (
        <div>
            <div class="w-full shadow p-5 rounded-lg bg-blue-100">
                <div class="relative">
                ...
                <div>
                    ...
                    <div className='flex flex-col '>
                        <select class="px-4 py-3 w-full mt-4 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
                        ...
                        {/* <div className='flex m-4 items-center'>
                            ...
                            <input
                                ...
                                class="px-8 py-3 w-[80%] ml-9 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm"
                            />
                        </div> */}
